...
public class DescriptionBuilder {
    public string BuildDescriptionForTargetDate(SchedulerInput requestedDate, TimeZoneInfo tz, DateTimeOffset nextLocal) {
    ...
    private string BuildWeeklyDescription(SchedulerInput requestedDate, TimeZoneInfo tz, DateTimeOffset nextLocal)  {
    ...
    private string BuildOnceDescription(SchedulerInput requestedDate, TimeZoneInfo tz, DateTimeOffset nextLocal) {
        var startDateStr = ConvertStartDateToZone(requestedDate, tz).ToShortDateString();
